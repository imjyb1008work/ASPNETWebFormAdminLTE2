<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DashboardGeneral.Master" AutoEventWireup="true" CodeBehind="General.aspx.cs" Inherits="ASPNETWebFormAdminLTE2.Pages.UI.General" %>
		...
		<div class="col-md-6">
			<div class="box box-solid">
				...
				<div class="box-body text-center">
					<p>
						By adding the class <code>.vertical</code> and <code>.progress-sm</code>, <code>.progress-xs</code> or
					...
					<div class="box-group" id="accordion">
                      ...
                      labore sustainable VHS.
						...
						<div class="panel box box-danger">
							<div class="box-header with-border">
								<h4 class="box-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Collapsible Group Danger
									</a>
								</h4>
							</div>
