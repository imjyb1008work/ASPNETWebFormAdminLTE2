<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DashboardGeneral.Master" AutoEventWireup="true" CodeBehind="ReadMail.aspx.cs" Inherits="ASPNETWebFormAdminLTE2.Pages.Mailbox.ReadMail" %>
			...
			<div class="box box-solid">
				...
				<div class="box-body no-padding">
					<ul class="nav nav-pills nav-stacked">
						<li>
							<asp:HyperLink ID="HyperLink2" NavigateUrl="~/Pages/Mailbox/Mailbox.aspx" runat="server"><i class="fa fa-inbox"></i>Inbox
                  <span class="label label-primary pull-right">12</span></asp:HyperLink>
						</li>
					...
					<ul class="mailbox-attachments clearfix">
						...
						<li>
							<span class="mailbox-attachment-icon has-img">
								<img src="../../dist/img/photo1.png" alt="Attachment"></span>
						...
						<li>
							...
							<div class="mailbox-attachment-info">
								...
								<span class="mailbox-attachment-size">1.9 MB
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
								</span>
							</div>
						</li>
